...
class DistrictsData {
  static const Map<String, List<String>> districts = {
    "Lahore": [
      "Lahore City", "Lahore Cantt", "Model Town", "Shalimar", "Raiwind",
      "Allama Iqbal", "Nishtar", "Saddar", "Wahga", "Ravi"
    ],
    ...
    "Gujrat": ["Gujrat", "Kharian", "Sarai Alamgir", "Jalalpur Jattan", "Khunjah"],
    "Hafizabad": ["Hafizabad", "Pindi Bhattian"],
    "Mandi Bahauddin": ["Mandi Bahauddin", "Phalia", "Malakwal"],
    "Wazirabad": ["Wazirabad", "Alipur Chatha"],
    "Rawalpindi": [
      "Rawalpindi Saddar", "Rawalpindi Cantt", "Rawalpindi City", "Kahuta",
      "Taxila", "Kallar Syedan", "Gujar Khan"
    ],
    "Murree": ["Murree", "Kotli Sattian"],
    "Chakwal": ["Chakwal", "Choa Saidan Shah", "Kallar Kahar"],
    "Attock": ["Attock", "Hassan Abdal", "Fateh Jang", "Jand", "Pindi Gheb", "Hazro"],
    ...
    "Bahawalpur": [
      "Bahawalpur City", "Bahawalpur Saddar", "Ahmadpur East", "Hasilpur",
      "Khairpur Tamewali", "Yazman"
    ],
    ...
    "Dera Ghazi Khan": ["Dera Ghazi Khan", "De-Excluded Area D.G. Khan", "Kot Chutta"],
    "Taunsa": ["Taunsa", "Koh-e-Suleman", "Wahova"],
    "Rajanpur": ["Rajanpur", "Jampur", "Rojhan", "De-Excluded Area Rajanpur"],
    "Layyah": ["Layyah", "Karor Lal Esan", "Chaubara"],
    "Kot Addu": ["Kot Addu", "Chowk Sarwar Shaheed"],
    "Muzaffargarh": ["Muzaffargarh", "Alipur", "Jatoi"],
    "Faisalabad": [
      "Faisalabad City", "Faisalabad Saddar", "Chak Jhumra", "Jaranwala",
    ...
    "Sargodha": [
      "Sargodha", "Bhalwal", "Bhera", "Kot Momin", "Shahpur",
      "Sahiwal (Sargodha Dist)", "Sillanwali"
    ],
...
List<String> getDistricts() {
  return DistrictsData.districts.keys.toList()..sort();
}

List<String> getTehsils(String district) {
  return DistrictsData.districts[district] ?? [];
}
